...
$('.tablaProductos tbody').on( 'click', 'button', function () {
	...
	//console.log("id asignacion",data[9]);
...
$("#nuevoPrecioCompra, #editarPrecioCompra").change(function(){
	//console.log("checked: ",$(".porcentaje").prop("checked"));

	if($(".porcentaje").prop("checked")){

		var valorPorcentaje = $(".nuevoPorcentaje").val();
		
		var porcentaje =  Math.round(Number(($("#nuevoPrecioCompra").val()*valorPorcentaje/100))+Number($("#nuevoPrecioCompra").val()));

		var editarPorcentaje = Math.round(Number(($("#editarPrecioCompra").val()*valorPorcentaje/100))+Number($("#editarPrecioCompra").val()));
		...
		//console.log($(".nuevoPrecioCompra").val(),$("#nuevoPrecioVenta").val(),$(".nuevDescripcion").val());
...
$(".nuevoPorcentaje").change(function(){
	...
	// porcentaje valdra el nuevo valor q asigne
	$(".nuevoPorcentaje").val($(this).val());
...
$(".tablaProductos tbody").on("click", "button.btnEditarProducto", function(){
	...
	console.log("btneditar: ",idProducto);
    ...
    datos.append("idProducto", idProducto);
 	$.ajax({
      ...
      success:function(respuesta){
	       ...
	       datosCategoria.append("id_Categoria",respuesta["id_categoria"]);
	          ...
	          dataType:"json",
	           success:function(respuest){
	            //console.log(respuest);
	               $("#editarCategoria").val(respuest["id"]);
	               $("#editarCategoria").html(respuest["categoria"]);
	       ...
	       // LLENO DE DATOS EL MODAL

	       // elimino lo q habia en input=files (el nombre dejado al cerrar el modal)
	       $(".nuevaImagen").val('');
